...
from STR import __version__ as module_version
...
project = 'ODAT-SE solver module: odatse-STR for sim-trhepd-rheed'
...
latex_documents = [
    (master_doc,
     'userguide_odatse-STR_en.tex',
     u'ODAT-SE SIM-TRHEPD-RHEED Module Documentation',
