...
- Bug Reports
  ...
  Please report all problems and bugs on the github `Issues <https://github.com/2DMAT/odatse-STR/issues>`_ page.

  To resolve bugs early, follow these guidelines when reporting:

  1. Please specify the version of ODAT-SE and odatse-STR you are using.
